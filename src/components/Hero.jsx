...
const Hero = () => {
  return (
    <main id="about">
      ...
      <p>Whether you're a coffee connoisseur or just looking for a cozy spot to relax, Aroma Cafe is here to brighten your day. Join us, take a seat, and indulge in the perfect blend of flavor, comfort, and good company.</p>
    </main>
  )
};
